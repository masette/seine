...
Joueur.decrire = function () {
    var description = this.nom + " a " + this.sante + " points de vie, " +
        this.force + " en force et XP " + this.xp + " Or "+this.inventairePiecesdOr+" Clef(s) "+this.inventaireClef;
    return description;
};
...
Joueur.combattre = function (adversaire) {
    ...
    if (adversaire.sante === 0) {
        ...
        this.inventairePiecesdOr += adversaire.inventairePiecesdOr;
        this.inventaireClef += adversaire.inventaireClef;
        adversaire.inventaireClef=0;
        adversaire.inventairePiecesdOr=0;
    }
};
